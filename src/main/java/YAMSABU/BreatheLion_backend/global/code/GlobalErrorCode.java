...
public enum GlobalErrorCode {
    ...
    RECORD_INVALID_TITLE(HttpStatus.BAD_REQUEST, "RECORD400-1", "제목 형식이 올바르지 않습니다."),
    RECORD_NOT_MODIFIABLE(HttpStatus.CONFLICT, "RECORD409", "이미 저장한 기록은 수정할 수 없습니다."),
    RECORD_NOT_FINALIZED(HttpStatus.CONFLICT, "RECORD409-1", "FINALIZED 상태에서만 수정이 가능합니다."),
    ...
    DRAWER_COUNT_UNDERFLOW(HttpStatus.CONFLICT, "DRAWER409", "서랍 카운트는 0이하가 될 수 없습니다."),
    // Evidence Error
